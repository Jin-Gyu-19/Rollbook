...
(function () {
  ...
  var CSS = [
    '.rbed { position: fixed; inset: 0; z-index: 3000; background: #F8FAFC; display: flex; flex-direction: column;',
    '  font: 400 13.5px/1.5 system-ui, -apple-system, "Noto Sans KR", sans-serif; color: #111827; }',
    '.rbed[hidden] { display: none; }',
    '.rbed-head { display: flex; align-items: center; gap: 10px; padding: 10px 16px; background: #111827; color: #fff; }',
    '.rbed-head b { font-size: 15px; }',
    '.rbed-tabs { display: flex; gap: 6px; margin-left: 8px; }',
    '.rbed-tabs button { padding: 7px 13px; border: 0; border-radius: 9px; background: rgba(255,255,255,.12);',
    '  color: #fff; font: 600 13px system-ui, sans-serif; cursor: pointer; }',
    '.rbed-tabs button.on { background: #fff; color: #111827; }',
    '.rbed-sp { flex: 1; }',
    '.rbed-msg { font-size: 12.5px; opacity: .85; }',
    '.rbed-msg.err { color: #FCA5A5; opacity: 1; }',
    '.rbed-msg.ok { color: #86EFAC; opacity: 1; }',
    '.rbed-head .go { padding: 8px 14px; border: 0; border-radius: 9px; background: #22C55E; color: #06230F;',
    '  font: 700 13px system-ui, sans-serif; cursor: pointer; }',
    '.rbed-head .go:disabled { opacity: .5; cursor: default; }',
    '.rbed-head .close { padding: 8px 12px; border: 0; border-radius: 9px; background: rgba(255,255,255,.12);',
    '  color: #fff; font: 600 13px system-ui, sans-serif; cursor: pointer; }',
    '.rbed-body { flex: 1; overflow: auto; padding: 18px 16px 60px; }',
    '.rbed-body h3 { margin: 0 0 4px; font-size: 15px; }',
    '.rbed-body .hint { margin: 0 0 14px; color: #6B7280; font-size: 12.5px; }',
    '.rbed-card { background: #fff; border: 1px solid #E5E7EB; border-radius: 12px; padding: 14px; margin-bottom: 14px; }',
    '.rbed-card > h4 { margin: 0 0 10px; font-size: 14px; display: flex; align-items: center; gap: 8px; }',
    '.rbed-card > h4 .n { color: #6B7280; font-weight: 500; font-size: 12.5px; }',
    '.rbed input[type=text], .rbed input[type=number], .rbed textarea {',
    '  width: 100%; padding: 6px 8px; border: 1px solid #D1D5DB; border-radius: 7px; background: #fff;',
    '  font: 400 13px/1.45 system-ui, -apple-system, "Noto Sans KR", sans-serif; color: #111827; }',
    '.rbed textarea { resize: vertical; min-height: 34px; }',
    '.rbed input:focus, .rbed textarea:focus { outline: 2px solid #93C5FD; outline-offset: -1px; }',
    '.rbed-f { display: grid; grid-template-columns: 90px 1fr; align-items: center; gap: 8px; margin-bottom: 8px; }',
    '.rbed-f label { color: #6B7280; font-size: 12.5px; }',
    '.rbed table { width: 100%; border-collapse: collapse; }',
    '.rbed th { text-align: left; font-size: 12px; color: #6B7280; font-weight: 600; padding: 0 6px 6px; }',
    '.rbed td { padding: 3px 6px 3px 0; vertical-align: top; }',
    '.rbed td.mini { width: 34px; padding-right: 0; }',
    '.rbed .rowbtn { width: 28px; height: 28px; border: 1px solid #E5E7EB; border-radius: 7px; background: #fff;',
    '  color: #6B7280; font: 600 13px system-ui, sans-serif; cursor: pointer; }',
    '.rbed .rowbtn:hover { background: #F3F4F6; color: #111827; }',
    '.rbed .rowbtn.del:hover { background: #FEF2F2; border-color: #FCA5A5; color: #B91C1C; }',
    '.rbed .add { margin-top: 8px; padding: 7px 12px; border: 1px dashed #CBD5E1; border-radius: 9px;',
    '  background: #fff; color: #334155; font: 600 12.5px system-ui, sans-serif; cursor: pointer; }',
    '.rbed .add:hover { background: #F1F5F9; }',
    '.rbed .tool { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; margin-bottom: 12px; }',
    '.rbed .tool input[type=text] { width: 220px; }',
    '.rbed .tool .cnt { color: #6B7280; font-size: 12.5px; }',
    '.rbed .grp { display: flex; align-items: center; gap: 8px; margin: 16px 0 6px; }',
    '.rbed .grp .t { font-weight: 700; font-size: 13.5px; }',
    '.rbed .grp input[type=text] { width: 150px; }',
