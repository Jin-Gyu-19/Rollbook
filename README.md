...
- **직접 편집**: 관리자 줄의 `직접 편집` 을 누르면 프로그램(제목·일정·강의 목록) · Grand Hall 조배정 · 석식 조배정을 화면에서 한 줄씩 고칠 수 있습니다. 조 번호를 바꾸면 그 사람이 그 조로 옮겨지고, 조 인원수·통계는 저장할 때 다시 셉니다. 저장하면 엑셀 게시와 똑같이 새 버전으로 쌓입니다.
